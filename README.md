...
| copy | Copy a file from one bucket to another ||
| rename | Renames a file |the original file is deleted|
| move | Moves a file from one bucket to an other |the original file is deleted|
...
| delete | Deletes a file from one bucket ||
| list | List all objects in a bucket ||


## Note
This implementation is partial has not implemented all the bucket operations 
